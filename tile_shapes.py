geometries = {
    ...
    (0, 1, 1, 1): {'type': 'flat-low', 'tri1': (1, 2, 3)},
    (1, 0, 0, 0): {'type': 'flat-high', 'tri1': (1, 2, 3), 'tri1': (0, 1, 3)},
    (1, 0, 0, 1): {'type': 'slope', 'quad': (0, 1, 2, 3)},
    (1, 0, 1, 0): {'type': 'saddle'},
    (1, 0, 1, 1): {'type': 'flat-low', 'tri1': (2, 3, 0)},
    (1, 1, 0, 0): {'type': 'slope', 'quad': (0, 1, 2, 3)},
    (1, 1, 0, 1): {'type': 'flat-low', 'tri1': (3, 0, 1)},
    (1, 1, 1, 0): {'type': 'flat-low', 'tri1': (0, 1, 2)},
}
